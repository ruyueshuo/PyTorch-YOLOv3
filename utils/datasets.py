...
class FireDataset(Dataset):
    def __init__(self, list_path, data_path, img_size=416, augment=True, multiscale=True, normalized_labels=True):
        with open(list_path, "r") as file:
            self.img_files = file.readlines()
    ...
    def __getitem__(self, index):
        ...
        img_path = self.img_files[index % len(self.img_files)].rstrip()
        img_path = os.path.join(self.data_path, 'JPEGImages', img_path+'.jpg')
        ...
        label_path = self.label_files[index % len(self.img_files)].rstrip()
        label_path = os.path.join(self.data_path, 'labels', label_path+'.txt')
